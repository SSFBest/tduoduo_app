...
export default function temai(state = initialState, action) {
  switch (action.type) {
    case types.FETCH_TEMAI_DATA:
      return Object.assign({}, state, {
        loading: true,
      });
    case types.RECEIVE_TEMAI_DATA:
      return Object.assign({}, state, {
        loading: false,
        img_list:action.data.img_list,
        temai:action.data.temai
      });
    default:
      return state;
  }
